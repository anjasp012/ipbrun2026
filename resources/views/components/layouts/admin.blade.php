    ...
    <div x-data="{ sidebarOpen: true }" class="flex min-h-screen">
        ...
        <div 
            ...
            <nav class="flex-1 p-4 space-y-2 mt-4 min-w-[256px]">
                ...
                <a href="{{ route('admin.blast') }}" class="flex items-center gap-3 p-3 rounded-xl sidebar-item {{ request()->is('admin/blast*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"></path></svg>
                    <span class="font-bold text-sm tracking-wide">Broadcast Message</span>
                </a>
                <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 p-3 rounded-xl sidebar-item {{ request()->is('admin/settings*') ? 'active' : '' }}">
