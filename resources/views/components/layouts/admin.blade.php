             ...
             <nav class="flex-1 p-6 space-y-3 mt-6 min-w-[320px]">
                 ...
                 @if ($isStaff)
                     <a href="{{ url('/admin/dashboard') }}"
                         class="flex items-center gap-4 p-4 rounded-lg sidebar-item {{ request()->is('admin/dashboard') ? 'active' : '' }}">
                     ...
                     <a href="{{ url('/admin/participants') }}"
                         class="flex items-center gap-4 p-4 rounded-lg sidebar-item {{ request()->is('admin/participants*') ? 'active' : '' }}">
                         <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                 ...
                 @if ($isSuper)
                     <a href="{{ url('/admin/categories') }}"
                         class="flex items-center gap-4 p-4 rounded-lg sidebar-item {{ request()->is('admin/categories*') ? 'active' : '' }}">
                         <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                     ...
                     <a href="{{ url('/admin/tickets') }}"
                         class="flex items-center gap-4 p-4 rounded-lg sidebar-item {{ request()->is('admin/tickets*') ? 'active' : '' }}">
                         <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                     ...
                     <a href="{{ route('admin.blast') }}"
                         class="flex items-center gap-4 p-4 rounded-lg sidebar-item {{ request()->is('admin/blast*') ? 'active' : '' }}">
                         <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                     ...
                     <a href="{{ route('admin.settings') }}"
                         class="flex items-center gap-4 p-4 rounded-lg sidebar-item {{ request()->is('admin/settings*') ? 'active' : '' }}">
                         <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
