        ...
        <div 
            ...
            <header class="bg-white h-24 border-b border-slate-200 sticky top-0 z-40 px-10 flex items-center justify-between shadow-sm">
                <div class="flex items-center gap-8">
                    <button @click="sidebarOpen = !sidebarOpen" class="p-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-400 hover:text-[#003366] hover:bg-white transition-all">
