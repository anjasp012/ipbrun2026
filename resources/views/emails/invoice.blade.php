...
<head>
    <meta charset="UTF-8">
    <title>IPB Run 2026 Invoice</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="invoice-container">
        ...
        <div class="invoice-table">
            <table>
                ...
                <tr class="table-row">
                    ...
                    <td class="item-total">IDR 4,500</td>
                </tr>
        ...
        <div class="footer">
            <div class="contact-info">
                <div class="contact-item"><span>+62 8567922780</span></div>
                <div class="contact-item"><span>+62 811-1231-088</span></div>
                <div class="contact-item"><span>ipbrun2026.id</span></div>
            </div>
        </div>
    </div>
</body>
