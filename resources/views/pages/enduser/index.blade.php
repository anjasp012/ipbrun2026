        ...
        <div
            ...
            <div class="relative custom-scrollbar flex-grow">
                ...
                @endphp
                 ...
                 <img src="{{ asset('/assets/images/Voucher Dekstop.png') }}" class="hidden md:block w-full h-auto rounded mb-16" alt="Voucher.png">
                ...
                <div class="flex justify-center mb-8 md:hidden">
                    <div class="inline-flex gap-2 p-1 bg-slate-50 rounded-xl border border-slate-200 shadow-sm w-full">
                        <button onclick="switchCategory('ipb')" id="tab-ipb"
                            class="flex-1 category-tab bg-[#00ACB1] text-white shadow-md px-4 py-2 rounded-lg text-xs font-[800] uppercase tracking-[1px] transition-all duration-300 active:scale-[0.98] whitespace-nowrap border border-transparent">
                            Kategori <br> Keluarga IPB
                        </button>
                        <button onclick="switchCategory('umum')" id="tab-umum"
                            class="flex-1 category-tab inactive-tab-pulse px-4 py-2 rounded-lg text-xs font-[800] uppercase tracking-[1px] transition-all duration-300 active:scale-[0.98] whitespace-nowrap text-slate-500 hover:text-[#00ACB1] border border-transparent">
                            Kategori <br> Umum
                        </button>
                    </div>
                </div>
                ...
                @foreach ($ticketGroups as $group)
                    @if (count($group['data']) > 0)
                        <div id="section-{{ $group['id'] }}"
                            class="ticket-section md:!block {{ $group['id'] !== 'ipb' ? 'hidden' : '' }} lg:mb-16 last:mb-0">
                            {{-- Section Header --}}
