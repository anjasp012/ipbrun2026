<x-layouts.app>
    ...
    <div class="py-12 md:py-20 flex items-center justify-center p-4">
        <div
            class="max-w-7xl mx-auto w-full bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border border-slate-100 relative flex flex-col p-6 md:p-16 overflow-hidden">
