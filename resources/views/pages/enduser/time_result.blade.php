<x-layouts.app>
    ...
    <div class="min-h-screen py-16 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div class="max-w-4xl w-full text-center mb-12 animate-fade-in">
            <h1 class="text-4xl md:text-5xl font-[900] text-white uppercase tracking-tight mb-1 drop-shadow-md">
                Race <span class="text-[#FF7A21]">Time Results</span>
            </h1>
            <p class="mb-2 text-white/40 text-[14px] uppercase tracking-widest font-semibold">unofficial</p>
