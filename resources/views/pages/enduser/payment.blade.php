    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
        <div
            ...
            <div class="p-8 text-center bg-white">
                ...
                <p class="text-[11px] text-slate-400 font-bold uppercase tracking-widest">Selesaikan pembayaran Anda
                    segera</p>
            </div>
            ...
            <div class="p-8 bg-slate-50/40">
                        ...
                        <div class="flex justify-between items-end">
                            <div class="flex flex-col">
                                <span
                                    ...
                                    Pembayaran</span>
                                <div
                                    class="text-[32px] font-[900] text-[#003366] leading-none font-['Plus_Jakarta_Sans']">
                ...
                <button id="pay-button"
                    class="w-full bg-[#003366] text-white py-4 rounded-xl font-[800] text-[15px] shadow-xl shadow-[#003366]/20 transition-all active:scale-95 hover:bg-[#002244] flex items-center justify-center gap-3">
        ...
        <a href="{{ url('/') }}"
            class="mt-8 text-slate-400 font-bold text-[11px] uppercase tracking-widest hover:text-[#003366] transition-all flex items-center gap-2">
