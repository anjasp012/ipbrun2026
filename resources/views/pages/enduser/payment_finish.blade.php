        ...
        <div class="max-w-[500px] w-full bg-white border border-slate-100 rounded-2xl shadow-2xl transition-all duration-300 overflow-hidden">
            ...
            <div class="p-8 text-center bg-white">
                @if($status == 'settlement' || $status == 'capture')
                    ...
                    <h1 class="text-2xl font-[900] text-[#003366] uppercase tracking-tight mb-2">Pembayaran Berhasil!</h1>
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Terima kasih! Pembayaran Anda telah kami terima. E-Tiket dan detail akun telah dikirimkan ke email <strong>{{ $email ?? 'Anda' }}</strong>.
                    </p>
                    <div class="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-100 inline-block">
                        <p class="text-[10px] text-blue-700 font-bold uppercase tracking-wider">Silakan cek folder Inbox atau Spam email Anda.</p>
                    </div>
                ...
                @elseif($status == 'pending')
                    ...
                    <h1 class="text-2xl font-[900] text-[#003366] uppercase tracking-tight mb-2">Menunggu Pembayaran</h1>
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Transaksi Anda sedang diproses. Segera selesaikan pembayaran sesuai instruksi di Midtrans agar slot Anda aman.
                    </p>
                ...
                @elseif($status == 'expire' || $status == 'cancel' || $status == 'deny')
                    ...
                    <p class="text-sm text-slate-500 leading-relaxed">
                        Maaf, transaksi Anda gagal, dibatalkan, atau telah kadaluarsa. Silakan coba lakukan pendaftaran ulang.
                    </p>
                @else
                    <!-- UNKNOWN -->
            ...
            <div class="p-8 bg-slate-50/40 text-center">
                ...
                <a href="{{ url('/') }}" class="inline-flex items-center justify-center w-full bg-[#003366] text-white py-4 rounded-xl font-[800] text-[15px] shadow-xl shadow-[#003366]/20 transition-all active:scale-95 hover:bg-[#002244] gap-2">
