        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead>
                        <tr class="bg-slate-50/50 border-b border-slate-100 uppercase tracking-widest text-[12px] font-black text-slate-400">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-10 py-8">
                                ...
                                @endforeach
                                <p class="text-[11px] font-bold text-slate-400 mt-1 tracking-widest">{{ $p->created_at->format('d/m/Y') }}</p>
                            </td>
                            <td class="px-8 py-8">
                                <div class="font-bold text-base text-slate-800 uppercase tracking-tighter">{{ $p->name }}</div>
                                <div class="text-[12px] font-medium text-slate-400 lowercase">{{ $p->email }}</div>
                            </td>
                            <td class="px-8 py-8">
                                ...
                                @endforeach
                                <div class="text-[11px] font-bold text-slate-400 mt-3 uppercase italic opacity-60">Jersey: {{ $p->jersey_size }}</div>
                            </td>
                            ...
                            <td class="px-8 py-8">
                                ...
                                <div class="flex items-center gap-3">
                                    <span class="px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-[11px] font-black uppercase tracking-widest border border-blue-100">
