                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
                    <div class="p-10 border-b border-slate-50 bg-slate-50/30 flex items-center justify-between">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h4 class="text-base font-black text-slate-800 uppercase tracking-wider">WhatsApp (Fonnte)</h4>
                                <p class="text-[12px] text-slate-400 font-bold uppercase tracking-widest mt-1">Notification Integration</p>
                            </div>
                        </div>
                    ...
                    <div class="p-10 space-y-8">
                        ...
                        <div>
                            <label class="text-[12px] font-black text-slate-400 uppercase tracking-widest block mb-2 ml-1">Fonnte API Token</label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none text-slate-300 group-focus-within:text-blue-500 transition-colors">
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
                    <div class="p-10 border-b border-slate-50 bg-slate-50/30 flex items-center justify-between">
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h4 class="text-base font-black text-slate-800 uppercase tracking-wider">Registration Schedule</h4>
                                <p class="text-[12px] text-slate-400 font-bold uppercase tracking-widest mt-1">Control when registration opens</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-10 space-y-8">
                        <div>
                            <label class="text-[12px] font-black text-slate-400 uppercase tracking-widest block mb-2 ml-1">Ticket Sale Start Date</label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none text-slate-300 group-focus-within:text-blue-500 transition-colors">
