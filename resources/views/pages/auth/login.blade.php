            ...
            <div class="relative z-10">
                ...
                <form id="loginForm" action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        @error('email')
                            <p class="text-red-500 text-[10px] font-black uppercase italic mt-2 ml-1 tracking-wider animate-pulse text-left">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        @error('password')
                            <p class="text-red-500 text-[10px] font-black uppercase italic mt-2 ml-1 tracking-wider text-left">{{ $message }}</p>
                        @enderror
                    </div>
