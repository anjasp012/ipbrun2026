<x-layouts.app title="Sign In - IPB RUN 2026" :withoutNavbar="true">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 sm:p-12">
        <!-- Login Card -->
        <div
            class="max-w-[480px] w-full bg-white/95 backdrop-blur-xl rounded-[2.5rem] shadow-[0_40px_80px_-15px_rgba(0,0,0,0.3)] border border-white/50 p-10 md:p-14 relative overflow-hidden group transition-all duration-500 hover:shadow-[0_50px_100px_-20px_rgba(0,0,0,0.35)]">

            <!-- Glow Effect -->
            <div
                class="absolute -top-24 -right-24 w-48 h-48 bg-orange-500/10 rounded-full blur-3xl group-hover:bg-orange-500/20 transition-all duration-700">
            </div>
            <div
                class="absolute -bottom-24 -left-24 w-48 h-48 bg-blue-600/10 rounded-full blur-3xl group-hover:bg-blue-600/20 transition-all duration-700">
            </div>
            ...
            <div class="relative z-10">
                ...
                <div class="text-center mb-10">
                    <div class="flex flex-col items-center gap-3">
                        <span class="text-[12px] font-black text-blue-600 uppercase tracking-[4px] opacity-80">IPB RUN
                            2026</span>
                        <h2 class="text-4xl font-[900] text-[#003366] leading-none uppercase tracking-tighter">Sign In
                        </h2>
                    ...
                    <div class="flex items-center justify-between pb-2 ml-1">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <div class="relative">
                                ...
                                <div
                                    class="w-5 h-5 bg-slate-100 border border-slate-200 rounded-lg peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-all flex items-center justify-center">
                            ...
                            <span
                                class="text-[11px] font-black text-slate-400 uppercase tracking-widest group-hover:text-slate-600 transition-colors">Remember
                                device</span>
                        </label>
                    </div>
                ...
                <div class="mt-12 text-center">
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-[2px] leading-relaxed">
                        Belum mendaftar? <br>
                        <a href="{{ url('/') }}"
                            class="text-blue-600 hover:text-blue-800 transition-colors border-b-2 border-blue-100 hover:border-blue-300 pb-0.5">Daftar
                            Tiket Disini</a>
                    </p>
                </div>
            </div>
